...
SIGNAL \INST3|INST2|carry_output~0_combout\ : std_logic;
SIGNAL \INST3|INST3|carry_output~0_combout\ : std_logic;
SIGNAL \INST4|multiplixer_output[0]~0_combout\ : std_logic;
SIGNAL \INST4|multiplixer_output[0]~1_combout\ : std_logic;
SIGNAL \INST4|multiplixer_output[3]~4_combout\ : std_logic;
SIGNAL \INST4|multiplixer_output[1]~2_combout\ : std_logic;
SIGNAL \INST4|multiplixer_output[2]~3_combout\ : std_logic;
SIGNAL \INST6|Mux5~0_combout\ : std_logic;
SIGNAL \INST3|INST2|sum_output~combout\ : std_logic;
SIGNAL \INST5|multiplixer_output[1]~1_combout\ : std_logic;
SIGNAL \INST5|multiplixer_output[2]~2_combout\ : std_logic;
SIGNAL \INST5|multiplixer_output[3]~3_combout\ : std_logic;
SIGNAL \INST5|multiplixer_output[0]~0_combout\ : std_logic;
...
-- Equation(s):
-- \INST8|clk_proc:COUNT[1]~1_combout\ = (\INST8|clk_proc:COUNT[0]~q\ & (\INST8|clk_proc:COUNT[1]~q\ $ (VCC))) # (!\INST8|clk_proc:COUNT[0]~q\ & (\INST8|clk_proc:COUNT[1]~q\ & VCC))
-- \INST8|clk_proc:COUNT[1]~2\ = CARRY((\INST8|clk_proc:COUNT[0]~q\ & \INST8|clk_proc:COUNT[1]~q\))
...
-- pragma translate_on
PORT MAP (
	dataa => \INST8|clk_proc:COUNT[0]~q\,
	datab => \INST8|clk_proc:COUNT[1]~q\,
	datad => VCC,
...
-- pragma translate_on
PORT MAP (
	dataa => \INST8|clk_proc:COUNT[8]~q\,
	datad => VCC,
...
-- pragma translate_on
PORT MAP (
	datab => \INST8|clk_proc:COUNT[9]~q\,
	datad => VCC,
...
-- Equation(s):
-- \INST8|clk_proc:COUNT[10]~1_combout\ = \INST8|clk_proc:COUNT[10]~q\ $ (\INST8|clk_proc:COUNT[9]~2\)
...
\INST3|INST2|carry_output~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST3|INST2|carry_output~0_combout\ = (\sw[5]~input_o\ & ((\sw[1]~input_o\) # ((\sw[0]~input_o\ & \sw[4]~input_o\)))) # (!\sw[5]~input_o\ & (\sw[0]~input_o\ & (\sw[1]~input_o\ & \sw[4]~input_o\)))
...
PORT MAP (
	...
	datac => \sw[1]~input_o\,
	datad => \sw[4]~input_o\,
	combout => \INST3|INST2|carry_output~0_combout\);

-- Location: LCCOMB_X11_Y17_N2
\INST3|INST3|carry_output~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST3|INST3|carry_output~0_combout\ = (\sw[2]~input_o\ & ((\sw[6]~input_o\) # (\INST3|INST2|carry_output~0_combout\))) # (!\sw[2]~input_o\ & (\sw[6]~input_o\ & \INST3|INST2|carry_output~0_combout\))
...
PORT MAP (
	datab => \sw[2]~input_o\,
	datac => \sw[6]~input_o\,
	datad => \INST3|INST2|carry_output~0_combout\,
	combout => \INST3|INST3|carry_output~0_combout\);

-- Location: LCCOMB_X11_Y17_N0
\INST4|multiplixer_output[0]~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST4|multiplixer_output[0]~0_combout\ = (\sw[3]~input_o\ & ((\sw[7]~input_o\) # (\INST3|INST3|carry_output~0_combout\))) # (!\sw[3]~input_o\ & (\sw[7]~input_o\ & \INST3|INST3|carry_output~0_combout\))
...
PORT MAP (
	datab => \sw[3]~input_o\,
	datac => \sw[7]~input_o\,
	datad => \INST3|INST3|carry_output~0_combout\,
	combout => \INST4|multiplixer_output[0]~0_combout\);

-- Location: LCCOMB_X11_Y17_N26
\INST4|multiplixer_output[0]~1\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST4|multiplixer_output[0]~1_combout\ = (\pb_n[2]~input_o\ & (\sw[4]~input_o\)) # (!\pb_n[2]~input_o\ & ((\INST4|multiplixer_output[0]~0_combout\)))
...
PORT MAP (
	...
	datab => \sw[4]~input_o\,
	datad => \INST4|multiplixer_output[0]~0_combout\,
	combout => \INST4|multiplixer_output[0]~1_combout\);

-- Location: LCCOMB_X11_Y17_N8
\INST4|multiplixer_output[3]~4\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST4|multiplixer_output[3]~4_combout\ = (\sw[7]~input_o\ & \pb_n[2]~input_o\)
...
PORT MAP (
	...
	combout => \INST4|multiplixer_output[3]~4_combout\);

-- Location: LCCOMB_X11_Y17_N28
\INST4|multiplixer_output[1]~2\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST4|multiplixer_output[1]~2_combout\ = (\pb_n[2]~input_o\ & \sw[5]~input_o\)
...
PORT MAP (
	dataa => \pb_n[2]~input_o\,
	datac => \sw[5]~input_o\,
	combout => \INST4|multiplixer_output[1]~2_combout\);

-- Location: LCCOMB_X11_Y17_N30
\INST4|multiplixer_output[2]~3\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST4|multiplixer_output[2]~3_combout\ = (\sw[6]~input_o\ & \pb_n[2]~input_o\)
...
PORT MAP (
	datac => \sw[6]~input_o\,
	datad => \pb_n[2]~input_o\,
	combout => \INST4|multiplixer_output[2]~3_combout\);

-- Location: LCCOMB_X13_Y17_N22
\INST6|Mux5~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST6|Mux5~0_combout\ = (\INST4|multiplixer_output[3]~4_combout\ & ((\INST4|multiplixer_output[0]~1_combout\ & (\INST4|multiplixer_output[1]~2_combout\)) # (!\INST4|multiplixer_output[0]~1_combout\ & ((\INST4|multiplixer_output[2]~3_combout\))))) # 
-- (!\INST4|multiplixer_output[3]~4_combout\ & (\INST4|multiplixer_output[2]~3_combout\ & (\INST4|multiplixer_output[0]~1_combout\ $ (\INST4|multiplixer_output[1]~2_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \INST4|multiplixer_output[0]~1_combout\,
	datab => \INST4|multiplixer_output[3]~4_combout\,
	datac => \INST4|multiplixer_output[1]~2_combout\,
	datad => \INST4|multiplixer_output[2]~3_combout\,
	combout => \INST6|Mux5~0_combout\);

-- Location: LCCOMB_X11_Y17_N12
\INST3|INST2|sum_output\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST3|INST2|sum_output~combout\ = \sw[5]~input_o\ $ (\sw[1]~input_o\ $ (((\sw[0]~input_o\ & \sw[4]~input_o\))))
...
PORT MAP (
	...
	datac => \sw[1]~input_o\,
	datad => \sw[4]~input_o\,
	combout => \INST3|INST2|sum_output~combout\);

-- Location: LCCOMB_X11_Y17_N14
\INST5|multiplixer_output[1]~1\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST5|multiplixer_output[1]~1_combout\ = (\pb_n[2]~input_o\ & (\sw[1]~input_o\)) # (!\pb_n[2]~input_o\ & ((\INST3|INST2|sum_output~combout\)))
...
PORT MAP (
	dataa => \pb_n[2]~input_o\,
	datac => \sw[1]~input_o\,
	datad => \INST3|INST2|sum_output~combout\,
	combout => \INST5|multiplixer_output[1]~1_combout\);

-- Location: LCCOMB_X11_Y17_N24
\INST5|multiplixer_output[2]~2\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST5|multiplixer_output[2]~2_combout\ = \sw[2]~input_o\ $ (((!\pb_n[2]~input_o\ & (\sw[6]~input_o\ $ (\INST3|INST2|carry_output~0_combout\)))))
...
PORT MAP (
	...
	datac => \sw[6]~input_o\,
	datad => \INST3|INST2|carry_output~0_combout\,
	combout => \INST5|multiplixer_output[2]~2_combout\);

-- Location: LCCOMB_X11_Y17_N22
\INST5|multiplixer_output[3]~3\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST5|multiplixer_output[3]~3_combout\ = \sw[3]~input_o\ $ (((!\pb_n[2]~input_o\ & (\sw[7]~input_o\ $ (\INST3|INST3|carry_output~0_combout\)))))
...
PORT MAP (
	...
	datac => \sw[7]~input_o\,
	datad => \INST3|INST3|carry_output~0_combout\,
	combout => \INST5|multiplixer_output[3]~3_combout\);

-- Location: LCCOMB_X11_Y17_N18
\INST5|multiplixer_output[0]~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST5|multiplixer_output[0]~0_combout\ = \sw[0]~input_o\ $ (((!\pb_n[2]~input_o\ & \sw[4]~input_o\)))
...
PORT MAP (
	...
	datac => \sw[0]~input_o\,
	datad => \sw[4]~input_o\,
	combout => \INST5|multiplixer_output[0]~0_combout\);

-- Location: LCCOMB_X13_Y17_N12
\INST7|Mux5~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST7|Mux5~0_combout\ = (\INST5|multiplixer_output[1]~1_combout\ & ((\INST5|multiplixer_output[0]~0_combout\ & ((\INST5|multiplixer_output[3]~3_combout\))) # (!\INST5|multiplixer_output[0]~0_combout\ & (\INST5|multiplixer_output[2]~2_combout\)))) # 
-- (!\INST5|multiplixer_output[1]~1_combout\ & (\INST5|multiplixer_output[2]~2_combout\ & (\INST5|multiplixer_output[3]~3_combout\ $ (\INST5|multiplixer_output[0]~0_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \INST5|multiplixer_output[1]~1_combout\,
	datab => \INST5|multiplixer_output[2]~2_combout\,
	datac => \INST5|multiplixer_output[3]~3_combout\,
	datad => \INST5|multiplixer_output[0]~0_combout\,
...
-- Equation(s):
-- \INST7|Mux1~0_combout\ = (\INST5|multiplixer_output[1]~1_combout\ & (!\INST5|multiplixer_output[3]~3_combout\ & ((\INST5|multiplixer_output[0]~0_combout\) # (!\INST5|multiplixer_output[2]~2_combout\)))) # (!\INST5|multiplixer_output[1]~1_combout\ & 
-- ((\INST5|multiplixer_output[2]~2_combout\ & (\INST5|multiplixer_output[3]~3_combout\)) # (!\INST5|multiplixer_output[2]~2_combout\ & (!\INST5|multiplixer_output[3]~3_combout\ & \INST5|multiplixer_output[0]~0_combout\))))
...
-- Equation(s):
-- \INST6|Mux1~0_combout\ = (\INST4|multiplixer_output[3]~4_combout\ & (((!\INST4|multiplixer_output[1]~2_combout\ & \INST4|multiplixer_output[2]~3_combout\)))) # (!\INST4|multiplixer_output[3]~4_combout\ & ((\INST4|multiplixer_output[0]~1_combout\ & 
-- ((\INST4|multiplixer_output[1]~2_combout\) # (!\INST4|multiplixer_output[2]~3_combout\))) # (!\INST4|multiplixer_output[0]~1_combout\ & (\INST4|multiplixer_output[1]~2_combout\ & !\INST4|multiplixer_output[2]~3_combout\))))
...
-- Equation(s):
-- \INST6|Mux0~0_combout\ = (\INST4|multiplixer_output[3]~4_combout\) # ((\INST4|multiplixer_output[1]~2_combout\ & ((!\INST4|multiplixer_output[2]~3_combout\) # (!\INST4|multiplixer_output[0]~1_combout\))) # (!\INST4|multiplixer_output[1]~2_combout\ & 
-- ((\INST4|multiplixer_output[2]~3_combout\))))
...
-- Equation(s):
-- \INST7|Mux0~0_combout\ = (\INST5|multiplixer_output[3]~3_combout\) # ((\INST5|multiplixer_output[1]~1_combout\ & ((!\INST5|multiplixer_output[0]~0_combout\) # (!\INST5|multiplixer_output[2]~2_combout\))) # (!\INST5|multiplixer_output[1]~1_combout\ & 
-- (\INST5|multiplixer_output[2]~2_combout\)))
...
-- Equation(s):
-- \INST2|Mux3~0_combout\ = (\pb_n[1]~input_o\ & ((\pb_n[0]~input_o\ & (\sw[0]~input_o\ & \sw[4]~input_o\)) # (!\pb_n[0]~input_o\ & ((\sw[0]~input_o\) # (\sw[4]~input_o\))))) # (!\pb_n[1]~input_o\ & (\pb_n[0]~input_o\ $ (\sw[0]~input_o\ $ 
-- (!\sw[4]~input_o\))))
...
-- Equation(s):
-- \INST2|Mux2~0_combout\ = (\pb_n[1]~input_o\ & ((\sw[1]~input_o\ & ((\sw[5]~input_o\) # (!\pb_n[0]~input_o\))) # (!\sw[1]~input_o\ & (\sw[5]~input_o\ & !\pb_n[0]~input_o\)))) # (!\pb_n[1]~input_o\ & (\sw[1]~input_o\ $ (\sw[5]~input_o\ $ 
-- (!\pb_n[0]~input_o\))))

-- pragma translate_off
GENERIC MAP (
	lut_mask => "1001001011101001",
	sum_lutc_input => "datac")
-- pragma translate_on
PORT MAP (
	dataa => \sw[1]~input_o\,
...
-- Equation(s):
-- \INST2|Mux0~0_combout\ = (\pb_n[1]~input_o\ & ((\pb_n[0]~input_o\ & (\sw[7]~input_o\ & \sw[3]~input_o\)) # (!\pb_n[0]~input_o\ & ((\sw[7]~input_o\) # (\sw[3]~input_o\))))) # (!\pb_n[1]~input_o\ & (\pb_n[0]~input_o\ $ (\sw[7]~input_o\ $ 
-- (!\sw[3]~input_o\))))

-- pragma translate_off
GENERIC MAP (
	lut_mask => "1101010001101001",
	sum_lutc_input => "datac")
-- pragma translate_on
PORT MAP (
	dataa => \pb_n[0]~input_o\,
...
-- Equation(s):
-- \INST6|Mux6~0_combout\ = (\INST4|multiplixer_output[1]~2_combout\ & (\INST4|multiplixer_output[0]~1_combout\ & (\INST4|multiplixer_output[3]~4_combout\ & !\INST4|multiplixer_output[2]~3_combout\))) # (!\INST4|multiplixer_output[1]~2_combout\ & 
-- (\INST4|multiplixer_output[2]~3_combout\ $ (((\INST4|multiplixer_output[0]~1_combout\ & !\INST4|multiplixer_output[3]~4_combout\)))))
...
-- Equation(s):
-- \INST7|Mux6~0_combout\ = (\INST5|multiplixer_output[1]~1_combout\ & (!\INST5|multiplixer_output[2]~2_combout\ & (\INST5|multiplixer_output[3]~3_combout\ & \INST5|multiplixer_output[0]~0_combout\))) # (!\INST5|multiplixer_output[1]~1_combout\ & 
-- (\INST5|multiplixer_output[2]~2_combout\ $ (((!\INST5|multiplixer_output[3]~3_combout\ & \INST5|multiplixer_output[0]~0_combout\)))))
...
-- Equation(s):
-- \INST7|Mux4~0_combout\ = (\INST5|multiplixer_output[2]~2_combout\ & (\INST5|multiplixer_output[3]~3_combout\ & ((\INST5|multiplixer_output[1]~1_combout\) # (!\INST5|multiplixer_output[0]~0_combout\)))) # (!\INST5|multiplixer_output[2]~2_combout\ & 
-- (\INST5|multiplixer_output[1]~1_combout\ & (!\INST5|multiplixer_output[3]~3_combout\ & !\INST5|multiplixer_output[0]~0_combout\)))
...
-- Equation(s):
-- \INST6|Mux4~0_combout\ = (\INST4|multiplixer_output[3]~4_combout\ & (\INST4|multiplixer_output[2]~3_combout\ & ((\INST4|multiplixer_output[1]~2_combout\) # (!\INST4|multiplixer_output[0]~1_combout\)))) # (!\INST4|multiplixer_output[3]~4_combout\ & 
-- (!\INST4|multiplixer_output[0]~1_combout\ & (\INST4|multiplixer_output[1]~2_combout\ & !\INST4|multiplixer_output[2]~3_combout\)))
...
-- Equation(s):
-- \INST7|Mux3~0_combout\ = (\INST5|multiplixer_output[1]~1_combout\ & ((\INST5|multiplixer_output[2]~2_combout\ & ((\INST5|multiplixer_output[0]~0_combout\))) # (!\INST5|multiplixer_output[2]~2_combout\ & (\INST5|multiplixer_output[3]~3_combout\ & 
-- !\INST5|multiplixer_output[0]~0_combout\)))) # (!\INST5|multiplixer_output[1]~1_combout\ & (!\INST5|multiplixer_output[3]~3_combout\ & (\INST5|multiplixer_output[2]~2_combout\ $ (\INST5|multiplixer_output[0]~0_combout\))))
...
-- Equation(s):
-- \INST6|Mux3~0_combout\ = (\INST4|multiplixer_output[1]~2_combout\ & ((\INST4|multiplixer_output[0]~1_combout\ & ((\INST4|multiplixer_output[2]~3_combout\))) # (!\INST4|multiplixer_output[0]~1_combout\ & (\INST4|multiplixer_output[3]~4_combout\ & 
-- !\INST4|multiplixer_output[2]~3_combout\)))) # (!\INST4|multiplixer_output[1]~2_combout\ & (!\INST4|multiplixer_output[3]~4_combout\ & (\INST4|multiplixer_output[0]~1_combout\ $ (\INST4|multiplixer_output[2]~3_combout\))))
...
-- Equation(s):
-- \INST7|Mux2~0_combout\ = (\INST5|multiplixer_output[1]~1_combout\ & (((!\INST5|multiplixer_output[3]~3_combout\ & \INST5|multiplixer_output[0]~0_combout\)))) # (!\INST5|multiplixer_output[1]~1_combout\ & ((\INST5|multiplixer_output[2]~2_combout\ & 
-- (!\INST5|multiplixer_output[3]~3_combout\)) # (!\INST5|multiplixer_output[2]~2_combout\ & ((\INST5|multiplixer_output[0]~0_combout\)))))
...
-- Equation(s):
-- \INST6|Mux2~0_combout\ = (\INST4|multiplixer_output[1]~2_combout\ & (\INST4|multiplixer_output[0]~1_combout\ & (!\INST4|multiplixer_output[3]~4_combout\))) # (!\INST4|multiplixer_output[1]~2_combout\ & ((\INST4|multiplixer_output[2]~3_combout\ & 
-- ((!\INST4|multiplixer_output[3]~4_combout\))) # (!\INST4|multiplixer_output[2]~3_combout\ & (\INST4|multiplixer_output[0]~1_combout\))))
