...
-- Equation(s):
-- \INST1|Mux6~0_combout\ = (\sw[3]~input_o\ & (\sw[1]~input_o\ $ (((\sw[2]~input_o\) # (!\sw[0]~input_o\))))) # (!\sw[3]~input_o\ & (!\sw[1]~input_o\ & (\sw[0]~input_o\ $ (\sw[2]~input_o\))))

-- pragma translate_off
GENERIC MAP (
	lut_mask => "0011100100010010",
...
-- Equation(s):
-- \INST1|Mux5~0_combout\ = (\sw[3]~input_o\ & (\sw[0]~input_o\ $ (((\sw[2]~input_o\) # (!\sw[1]~input_o\))))) # (!\sw[3]~input_o\ & (\sw[2]~input_o\ & ((\sw[0]~input_o\) # (\sw[1]~input_o\))))

-- pragma translate_off
GENERIC MAP (
	lut_mask => "0101100111100000",
	sum_lutc_input => "datac")
-- pragma translate_on
PORT MAP (
	dataa => \sw[0]~input_o\,
...
-- Equation(s):
-- \INST1|Mux4~0_combout\ = (\sw[0]~input_o\ & (\sw[1]~input_o\ & (\sw[2]~input_o\ & !\sw[3]~input_o\))) # (!\sw[0]~input_o\ & (\sw[3]~input_o\ $ (((\sw[1]~input_o\ & !\sw[2]~input_o\)))))
...
-- Equation(s):
-- \INST1|Mux3~0_combout\ = (\sw[0]~input_o\ & ((\sw[1]~input_o\ & (\sw[2]~input_o\)) # (!\sw[1]~input_o\ & (!\sw[2]~input_o\ & !\sw[3]~input_o\)))) # (!\sw[0]~input_o\ & ((\sw[2]~input_o\ & (!\sw[1]~input_o\ & !\sw[3]~input_o\)) # (!\sw[2]~input_o\ & 
-- ((\sw[3]~input_o\)))))

-- pragma translate_off
GENERIC MAP (
	lut_mask => "1000010110010010",
	sum_lutc_input => "datac")
-- pragma translate_on
PORT MAP (
	dataa => \sw[0]~input_o\,
...
-- Equation(s):
-- \INST1|Mux2~0_combout\ = (\sw[0]~input_o\ & ((\sw[1]~input_o\ $ (!\sw[2]~input_o\)) # (!\sw[3]~input_o\))) # (!\sw[0]~input_o\ & (!\sw[1]~input_o\ & (\sw[2]~input_o\ $ (\sw[3]~input_o\))))
...
-- Equation(s):
-- \INST1|Mux1~0_combout\ = (\sw[1]~input_o\ & ((\sw[2]~input_o\ & (\sw[0]~input_o\)) # (!\sw[2]~input_o\ & ((!\sw[3]~input_o\))))) # (!\sw[1]~input_o\ & (\sw[3]~input_o\ $ (((\sw[0]~input_o\ & !\sw[2]~input_o\)))))

-- pragma translate_off
GENERIC MAP (
	lut_mask => "1011000110001110",
	sum_lutc_input => "datac")
-- pragma translate_on
PORT MAP (
	dataa => \sw[0]~input_o\,
